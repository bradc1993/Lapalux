          ...
          <div className="about-container">
            <div className="about-section" key="about-section-1">
              ...
              <p className="about-paragraph">
                ...
                never ending continuum. He channels these ideas through a
                modular synth set-up, weaving human emotion and temporal field
                recordings into the record, all of which lend a tangible,
                ethereal feel to its technical composition.
              </p>
            </div>
            <div className="about-section" key="about-section-2">
              ...
              <p className="about-paragraph">
                ...
                this record.” explains Howard, “People are sitting in what looks
                like a waiting room lit in a purple hue, looking up at the dark
                night sky through a rectangular hole in the ceiling. The image
                has so much depth and means so much to me.... it seems like we
                are all in that waiting room, waiting to be somewhere or go
            ...
            <div className="about-section" key="about-section-3">
              ...
              <p className="about-paragraph">
                ...
                and perspective. Conceived by Creative Director and photographer
                Dan Medhurst and Owen Gildersleeve—an expert in hand-crafted
                illustration and set design—the build stemmed from a vision that
                Howard imagined: “I initially had an idea of a person, or group
                of people, in an impossibly large room set in a fog of pink
                looking into a void symbolic of a womb or amniotic sac,” he
                says. “We then ran with the idea of making a structure that had
                a deeper perspective, the ever decreasing octagon shape that
